...
class PlayerEventListener(var player: ExoPlayer, flutterEngine: FlutterEngine) :
    EventChannel.StreamHandler, Player.Listener {
    private val eventChannelName = "playerListenerChannelTag"
    private var channelEvent: EventChannel =
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, eventChannelName)
    private var eventSink: EventChannel.EventSink? = null
    private var handler: Handler = Handler()
    private val timerToSendCurrentTime: Long = 500
    ...
    override fun onPlayerError(error: PlaybackException) {
        ...
        error.message?.let { Log.e("PlayerEvent", it) }
    }
